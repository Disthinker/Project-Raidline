...
当前实现计划：`active/home-region-founding-v1.md`。PR #146 已由用户授权以 `f92df3e` 普通合入 main；当前从该基线实现同一 Home Region 三地块考察、唯一核心建立、现有建设/整备/首次出击。旧愿望/远征计划保留为已完成历史证据；不引入导航、新路线节点、实时守城或正式美术。
