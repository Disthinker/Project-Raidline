...
当前实现计划：`active/raid-continuous-high-risk-v1.md`。Persistent Base、Extraction Loop、Alpha Hardening、Survival Loadout、Combat PR #66～#74 与固定地图 PR #73 已接受；旧活动文档保留交付证据。
