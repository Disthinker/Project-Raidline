...
当前实现计划：`active/base-dormitory-expansion-v1.md`。Persistent Base、Extraction Loop、Alpha Hardening、Survival Loadout、Combat、Raid Pressure 与 Base Growth PR #78～#86 已接受；旧活动文档保留交付证据。
