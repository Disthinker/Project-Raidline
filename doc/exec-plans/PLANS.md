...
当前实现计划：`active/raid-travel-time-v1.md`。Persistent Base、Extraction Loop、Alpha Hardening、Survival Loadout、Combat PR #66～#74、固定地图 PR #73 与 Base 世界时钟 PR #79 已接受；旧活动文档保留交付证据。
