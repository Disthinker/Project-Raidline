...
- content v52；schema 保持 v38，因实例保存结构不变；rules 保持 v28，因本切片只向现有语义 Loot 表补充定义、不改变冻结快照结构与抽取规则。content v51 与更早受支持版本继续加载。
...
- [x] 完成 429 项 focused tests、Windows Debug 和 1303/1303 完整 CTest。
