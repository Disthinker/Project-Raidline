...
| RL-BASE-010 | 玩家必须打开建设管理卡或运营总览，才能知道世界设施正在工作、产物待取、缺员或不可用 | 当前分支将现有管理领域事实投影为入口服务点状态，并统一世界提示与 Home Region 地图表现；Windows Debug、134/134 定向回归与 1416/1416 全量 CTest 已通过，等待 exact-head CI 与用户正常游玩验收 |
