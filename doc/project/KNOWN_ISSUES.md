...
| Regional Operations：唯一主基地迁徙 v1 | 当前分支已完成唯一科技核心、厨房/净水建设、设施储备/免费重装、12 小时原子迁徙、旧基地转离线前哨、队列精确暂停、schema v30/content v39 和双语投影；Windows Debug 全目标与 1180/1180 CTest 通过。正式基地布局、随机损失、设施耐久/独特效果和尸潮预警门禁延期 |
...
具体依赖、自动化、人工验收和回滚见 `doc/exec-plans/active/regional-main-base-migration-v1.md`。
