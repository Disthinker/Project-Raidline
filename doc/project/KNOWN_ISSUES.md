...
| RL-BASE-016 | 五类作业点始终显示完整状态文字，缩远时信息拥挤；运营总览也缺少短缺/居民压力与筛选分页 | 当前分支已建立缩放信息层级、状态分类、筛选分页和点击定位；Windows Debug 全目标、71/71 定向与 1433/1433 全量 CTest 通过，等待 CI 和用户验收；不新增模拟状态 |
