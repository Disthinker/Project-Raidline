...
| RL-BASE-007 | 厨房/净水首次建设只写入隐藏等级并直接标记 Installed，BaseWorld 没有对应设施实体 | 当前分支已让完成结果进入 Reserve，经建设面板部署为第五类空间核心设施，并为 schema v40 旧档补齐确定性布局；Windows Debug 与 1405/1405 CTest 通过，待用户正常游玩验收 |
