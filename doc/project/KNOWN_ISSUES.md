...
| Regional Operations：失物记录与行动老化 v1 | Draft PR #101 实现死亡/主动退出失物记录、后续行动老化、schema v24/content v34、Base 记录页与到期警告；Windows Debug 全目标、定向回归、1106/1106 CTest 和实现 HEAD 的 exact-head CI 已通过，最终证据 HEAD 复核与用户验收待完成；NPC 委托和 Raid 内自力寻回仍延期 |
