...
| RL-BASE-017 | Home Region 基地外仍是无风险空场景，统一大地图缺少本地外围探索闭环 | 当前分支建立安全核心/过渡缓冲/外围、有限感染者、低阶 Loot 和保留资产的返回/救回结果；Windows Debug、42/42 关键回归和 1444/1444 全量 CTest 已通过，等待 exact-head CI 和用户验收；不嵌入 Raid 生命周期且不提供导航 |
