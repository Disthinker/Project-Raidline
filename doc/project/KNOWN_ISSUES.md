...
| Regional Operations：区域路线与轻量哨所基础 | 当前分支已完成区域最短路径、建立哨所、2 人聚合驻守和固定捷径；Windows Debug 全目标与 1150/1150 CTest 通过，exact-head CI 和用户统一正常游玩验收待完成。主基地选址/迁徙、哨所库存/服务/升级、外围清理、失联/遇袭和正式资源继续延期 |
...
具体依赖、自动化、人工验收和回滚见 `doc/exec-plans/active/regional-route-outpost-foundation.md`。
