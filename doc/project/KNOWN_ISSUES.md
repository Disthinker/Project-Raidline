...
| RL-COMBAT-006 | 准星响应、极端横向后坐力、OS 光标离窗与基础听觉反馈 | 输入/后坐力已迁移为高响应默认值、连续弯曲和 Raid 相对鼠标捕获；程序化 cue 已被 ArtWorkbench P0 Sound Event 音频库取代，代码 head `f779d31` CI 成功，待用户正常游玩验收 |
