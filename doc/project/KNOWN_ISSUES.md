...
| RL-AI-001 | 一名敌人进入攻击阶段后，其余警觉敌人被降为 Support 并在等待距离带内停住；冷却中的最近敌人还会阻塞队友后续攻击 | 当前分支拆分 Pressure 追击角色与单一攻击许可，并以只读攻击机会查询让冷却成员让位；Windows Debug 全目标、226/226 定向回归和 1102/1102 完整 CTest 已通过，待 exact-head CI 与用户正常游玩验收 |
