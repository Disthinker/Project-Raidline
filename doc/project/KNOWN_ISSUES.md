...
| RL-POP-003 | 聚合居民缺少专业构成与互斥岗位，设施等级也没有成为现有服务的实际消费者 | 当前分支已实现四类聚合专业、工坊/医疗所互斥岗位、专业效率和两个线性设施升级，Windows Debug 与 CTest 1010/1010 通过；等待 exact-head CI 和用户正常游玩验收，具名 NPC、培训、战斗小组和复杂居民模拟继续延期 |
