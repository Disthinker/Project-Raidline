...
| RL-BASE-001 | Base 缺少以真实资产、劳动力和世界时间驱动的生产消费者 | 当前 `codex/base-basic-manufacturing-v1` 实现单工坊槽和一项维护包配方；投入/产出保持稳定资产身份，仓库阻塞与 Raid 回滚保持原子性 |
...
具体依赖、自动化、人工验收和回滚见 `doc/exec-plans/active/base-basic-manufacturing-v1.md`。
