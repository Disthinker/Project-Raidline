...
| RL-MAP-012 | `Frontier Exchange` 的持续高危仍使用全图统一增援节奏和固定高级资源区，缺少地图级危机差异 | 当前分支以 content v51/schema v38/rules v28 冻结道路、工业、货运三类危机及合法目标、压力来源和主题高级 Loot；正式实时尸潮、动态封路、停电/火灾和新敌人类型继续延期 |
