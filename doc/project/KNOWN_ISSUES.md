...
| RL-UI-001 | Alpha Profile 库存回归为点击来源/目标和验收按钮，Base 缺角色图；弹匣右键入口会被执行预查询错误隐藏 | PR #60 已改为共享拖拽、领域预览、稳定右键动作和批准角色资源；Base 可即时卸弹，Raid 可执行 3 秒可中断卸弹；本地 640/640 通过，等待新 head CI 与人工验收 |
...
| Alpha Hardening | 当前分支已完成恢复/救济修复、库存/角色显示返工和 Base/Raid 弹匣右键卸弹；Windows Debug 全目标、全量 640/640 通过，等待新 head CI 与最终正常游玩验收 |
