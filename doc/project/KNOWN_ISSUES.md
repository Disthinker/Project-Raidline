...
| RL-COMBAT-007 | 常规瞄准仍有惯性、散布缺少移准/近距曲线、旧曳光像慢速实体弹 | Draft PR #69 实施 Direct/高倍模式分离、移准与距离散布、4200/7200 逻辑弹速和三段式短线曳光；本地 761/761 与实现 head CI 通过，等待最终文档 head CI 和用户正常游玩验收 |
...
| Combat：直接瞄准、距离散布与高速曳光 v2 | Draft PR #69 已完成实现、Windows Debug 构建、761/761 CTest 和实现 head CI；等待最终文档 head CI 与用户正常游玩验收 |
