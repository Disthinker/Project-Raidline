...
| RL-AI-002 | 超大地图 36～48 名初始敌人仍是独立随机散点，路线、资源与地标没有形成可理解的遭遇压力 | 当前 Macro 3 分支以 content v47/schema v37 冻结巡逻、地标守点、路线伏击和同组声响响应；复用既有视线/搜索/寻路预算，不扩张为新 AI 大阶段，待完整 CI 与用户正常游玩验收 |
