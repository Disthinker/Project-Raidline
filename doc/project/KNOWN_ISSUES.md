...
| RL-AI-001 | 一名敌人进入攻击阶段后，其余警觉敌人被降为 Support 并在等待距离带内停住；旧单槽方案又会让围攻显得不自然 | 当前分支拆分 Pressure 与攻击槽，按用户修订允许最多 10 名并发攻击、超额成员稳定轮转，并加入 0.25 秒敌人伤害保护；Windows Debug 全目标、233/233 定向回归和 1108/1108 完整 CTest 已通过，待 exact-head CI 与用户正常游玩验收 |
