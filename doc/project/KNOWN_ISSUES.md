...
| RL-UI-001 | Alpha Profile 库存回归为点击来源/目标和验收按钮，Base 缺角色图 | PR #60 已改为 Base/Raid 共享拖拽、领域预览、右键动作和批准角色资源；本地 637/637 与 exact-head CI 通过，等待人工验收 |
...
| Alpha Hardening | 当前分支已完成恢复/救济修复和库存/角色显示返工；Windows Debug 全目标、全量 637/637 与 PR #60 exact-head CI 通过，等待最终正常游玩验收 |
