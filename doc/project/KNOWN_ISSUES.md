...
| RL-BASE-009 | 基地设施从整个建筑矩形四周均可交互，建设放置也不能保护未来入口和 NPC 作业空间 | 当前分支已建立确定性入口、交互区和作业净空区；设施、储物箱和环境物不能堵住入口。Windows Debug、97/97 定向回归与 1414/1414 全量 CTest 已通过，等待 exact-head CI 与用户正常游玩验收 |
