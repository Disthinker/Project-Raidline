...
| RL-BASE-014 | 宿舍床位只有通用作业点图形，基地世界无法直接读取聚合居民、伤病、床位与劳动力占用 | Draft PR #141 已建立只读居民空间投影，并让 DormitoryBunk 提供一致的状态、宿舍入口和自动补员；本地 Windows Debug、158/158 定向回归和 1424/1424 全量 CTest 通过，尚待 exact-head CI 与用户正常游玩验收；不新增逐人居民状态 |
