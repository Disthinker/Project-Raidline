...
| RL-INV-002 | Ctrl/Shift 数量选择后的拖拽锁定不完整 | PR #58 的点击脚手架已在当前 Hardening 分支返工：按下锁定数量、超过 4 像素开始拖动、释放提交；等待 PR #60 CI 与最终人工验收 |
| RL-INV-003 | 同定义弹药堆叠与 60 发上限 | PR #54 已合入并完成人工验收 |
| RL-UI-001 | Alpha Profile 库存回归为点击来源/目标和验收按钮，Base 缺角色图 | 当前 Hardening 分支已改为 Base/Raid 共享拖拽、领域预览、右键动作和批准角色资源；本地 637/637 通过，等待 CI/人工验收 |
...
| Alpha Hardening | 当前分支已完成恢复/救济修复和库存/角色显示返工；Windows Debug 全目标与全量 637/637 通过，等待 PR #60 exact-head CI 与最终正常游玩验收 |
