...
| RL-COMBAT-011 | 相对鼠标模式的实际准星与控制目标可持续移动到当前屏幕外，玩家可能无法找回准星 | Draft PR #111 当前分支允许权威准星和目标越出当前屏幕约 48px（约一个当前准星直径），再由外扩边界清除外向速度；反向输入立即生效，世界边缘仍是硬边界。Windows Debug 与 1253/1253 CTest 通过，待 exact-head CI 和用户正常游玩验收 |
