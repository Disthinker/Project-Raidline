...
| Home Region 共享战斗能力 v1 | 基地大地图可使用与 Raid 一致的准星、武器切换、射击和反馈；真实消耗弹药/耐久并可能故障 | SDL-free WorldShootingRuntime、Base/Raid 窄能力复用、Profile FireWeapon 事务、周期原子检查点、无 Raid 生命周期 | 当前开发分支；不引入敌人、设施伤害、撤离、高危或 Settlement |
