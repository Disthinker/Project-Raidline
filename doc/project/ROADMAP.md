...
| 动态散布模型与准星稳定性 v3 | 距离不再遮蔽动态扩散；轻微甩动不满扩散；快速甩动快展缓收；走路立即大扩散、奔跑更大；横向后坐力明显且连续 | 距离包络、四源 Bloom、连续鼠标 attack/release、走跑独立目标与即时激活、连续 WeaponAccuracyProjection、F10 Distance/Movement/Sprinting Bloom | PR #71 第二轮 head `13176d9` CI 已通过；第三轮 Windows Debug 全目标、149 项定向回归与 780/780 CTest 通过，最终 CI 与人工验收待完成 |
