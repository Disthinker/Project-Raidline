...
| Alpha Hardening | 连续多局、退出回滚、损坏恢复、三组路线配置、可正常游玩的统一库存与完整产品验收 | 稳定性、恢复、领域驱动交互、平衡、发布证据 | Raid 压卸弹、奔跑及出击前存档回滚后本地 Windows Debug 全目标、644/644 与功能 head CI 通过；等待最终人工验收 |
