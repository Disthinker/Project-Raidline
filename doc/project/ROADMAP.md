...
Core Extraction Alpha 到 Regional Operations 基础阶段、“首张可玩随机大地图”阶段、Content Beta 成长闭环，以及 Home Region 设施岗位现场操作均已进入主线。当前聚合居民空间状态 v1 已完成本地实现与回归，等待 exact-head CI 和用户正常游玩验收；范围合同见 `doc/exec-plans/active/home-region-resident-world-status-v1.md`，外部 GDD 继续只读。
