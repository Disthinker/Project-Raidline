...
Week28 已在 `main` 实现距离感知滞回、最后已知位置搜索、平滑转向、默认三敌人、局部分离和单主攻/支援协调。Week29 正在强化战斗反馈与抓/挠/咬动画接线，正式帧资产尚未生产和批准。尚未实现：最终主菜单/基地美术与功能、地图副本选择、敌人视锥/遮挡/听觉、寻路/避障、复杂仇恨与编队、正式抓/挠/咬动画与音效、可操作 Stash UI、从 Stash 选择出战物、跨进程保存、局内重开、多柜体/搜索计时、外部数据驱动 Loot、治疗、击退/受伤表现、装备栏、上下文菜单、重量/耐久、音频、程序地图、尸体搜索和完整武器装填/弹匣系统。Week28 的确定性距离感知与小队协调仍是 V0，不代表完整敌人智能或正式战斗表现；Week26 的代码准星、弹道和后坐力是可调 V0，不代表完整武器系统；Week25 只是代码绘制的单地图流程壳，不代表基地系统或多地图内容完成；新 Raid 使用空背包，也不代表配装或持久化已经完成。9mm 只是数量物品，不代表完整武器弹药系统已经完成。
