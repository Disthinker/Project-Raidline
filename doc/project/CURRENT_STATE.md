...
- `origin/main@a7b3cc2` 已包含完整 Core Extraction Alpha、Survival Loadout、Combat、Raid Pressure、Base Growth、区域地图情报，以及 PR #93～#97 接受的 Raid World Vertical Slice 基线。
- 当前开发分支：`codex/raid-world-spatial-tactical-reliability-v1`，从干净的 `origin/main@a7b3cc2` 创建。
- 当前活动计划：`doc/exec-plans/active/raid-world-spatial-tactical-reliability-v1.md`。
