...
- PR #90 的士气与周期事件及 PR #91 的岗位/设施升级均已通过双平台 CI、用户正常游玩验收并进入 main。当前区域地图与情报分支已完成 schema v20/content v28、购买/部署/回滚领域合同、战术地图、探索迷雾、三类情报投影和双语文字/图形占位；Windows Debug 全目标与完整 CTest 1026/1026 通过，exact-head CI 待完成。开发代理未启动游戏。
