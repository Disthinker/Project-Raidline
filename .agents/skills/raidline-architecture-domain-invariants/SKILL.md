...
Require focused invariant tests for success, rejection, capacity failure, duplicate ID, interruption, retry, and idempotency. Treat compiler/static analysis as evidence, not proof of gameplay correctness.
